...
enum Period {
  ONE_HOUR(60 * 60 * 1000, "1min"), SIX_HOURS(6 * 60 * 60 * 1000, "1min"), TWELVE_HOURS(12 * 60 * 60 * 1000, "2min"), ONE_DAY(1 * 24 * 60 * 60 * 1000, "4min"), TWO_DAYS(2 * 24 * 60 * 60 * 1000, "8min"), ONE_WEEK(7 * 24 * 60 * 60 * 1000, "30min");
